...
namespace ECommerce.Api.Orders.Providers
{
    public class OrdersProvider : IOrdersProvider
    {
        ...
        public async Task<(bool IsSuccess, IEnumerable<Models.Order> Orders, string ErrorMessage)> GetOrdersAsync(int customerId)
        {
            ...
            //        .Select<IEnumerable<Order>, Order>(o => new Order() { o.Id, o.CustomerId, o.OrderDate, o.Total })
            //        //.ToListAsync()
            //        ;
            ...
            //    {
            //        var result = mapper.Map<IEnumerable<Db.Order>, IEnumerable<Models.Order>>((IEnumerable<Order>)Orders,);
            ...
            try
            {
                var orders = await dbContext.Orders
                    //.Select(o => new { o.Id, o.CustomerId, o.OrderDate, o.Total })
